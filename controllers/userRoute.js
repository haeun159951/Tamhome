    ...
    userModel.findOne({ email: req.body.email }).then((user) => {
      ...
      if (user) {
        ...
        register
          ...
          .then(() => {
            console.log(
              "Your information was successfully inserted into database"
            );
          })
          .catch((err) => {
            console.log(
              `Error occurs while inserting data into database ${err}`
            );
          });
        ...
        var emailOptions = {
          ...
          html:
            "<p>Hello " +
            req.body.fname +
            "</p><p>Thank you for signing up at Tamhome. </p>",
        };
    ...
    userModel
      ...
      .then((user) => {
        ...
        //Email matching
          ...
          bcrypt
            .compare(req.body.password2, user.password2)
            .then((isCorrect) => {
              if (isCorrect == true) {
